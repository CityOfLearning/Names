...
public class SetProximityBlock extends Show {
	...
	public void setup() {
		...
		registerComponent(new TextLabel((int) (width * .28), (int) (height * .3), 170, 60, Color.black,
				"Set Proximity Area:\n\n X:              Y:              Z:\n\n\nX2:             Y2:            Z2:")
						.setMultilined(true));
		...
		registerComponent(
				new TextBox((int) (width * .47), (int) (height * .35), 45, 20).setText("" + block.getCorner1().getY())
						.setTextChangedListener((TextBox textbox, String previousText) -> {
							if (!previousText.isEmpty()) {
								try {
		...
		registerComponent(
				new TextBox((int) (width * .47), (int) (height * .45), 45, 20).setText("" + block.getCorner2().getY())
						.setTextChangedListener((TextBox textbox, String previousText) -> {
							if (!previousText.isEmpty()) {
								try {
